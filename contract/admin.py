...
@admin.register(models.TempContractor)
class TempContractorAdmin(BaseAdmin):
    icon = '<i class="material-icons">nature_people</i>'
    list_display = ('name', 'category', 'address1', 'address2')
...
@admin.register(models.TempContract)
class TempContractAdmin(BaseAdmin):
    list_display = ('contractor', 'parking_lot', 'parking_position', 'contract_date', 'start_date', 'end_date')
    list_display_links = ('contractor',)
